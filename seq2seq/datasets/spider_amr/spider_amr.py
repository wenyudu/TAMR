...
_URL = "https://mnt.ks3-cn-beijing.ksyuncs.com/wydu/spider.zip?AccessKeyId=AKLThZW161D0TAevVVl01MBeNg&Expires=6166435580&Signature=DtN6QnBQoUkZTnCBXYCK1vymX08%3D"
# _URL = "http://16.162.122.86:8080/spider.zip"
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "amr_filepath": os.path.join("amr2.0/train.source"),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "db_path": os.path.join(downloaded_filepath, "spider/database"),
                    "amr_filepath": os.path.join("amr2.0/dev.source"),
                },
            ),
        ]

    def _generate_examples(
        self, data_filepaths: List[str], db_path: str, amr_filepath: str
    ) -> Generator[Tuple[int, Dict[str, Any]], None, None]:
        """This function returns the examples in the raw (text) form."""
        with open(amr_filepath,mode='r') as amr_f:
